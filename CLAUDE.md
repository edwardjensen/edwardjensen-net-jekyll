...
- **`_camerastream_sections/`** - Camera stream page sections (not output)
...
**URL:** `/saintpaulcamera/`
**Layout:** `landing-page`
**Sections Collection:** `_camerastream_sections/`

**Key Files:**

- **[saintpaullive.md](_site_pages/saintpaullive.md)** - Page definition with front matter
- **[livestream.html](_camerastream_sections/livestream.html)** - Cloudflare Stream iframe embed
