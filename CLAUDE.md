...
- **[featured-tag-feed.xml](_layouts/featured-tag-feed.xml)** - RSS feed layout for featured tags (auto-generated by plugin)
...
**RSS Feeds:** Automatically generated for each featured tag via a Jekyll plugin ([_plugins/featured_tag_feeds.rb](_plugins/featured_tag_feeds.rb)). Each tag gets a feed at `/feeds/{tag-slug}.xml` using the [featured-tag-feed.xml](_layouts/featured-tag-feed.xml) layout. The feed description uses the markdown body content from the featured tag file.
